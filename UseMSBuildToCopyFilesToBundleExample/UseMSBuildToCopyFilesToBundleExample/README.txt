...
This is better the custom commands in your projects settings, as they will fire even when building via xbuild.

They also fire before code signing, so they may not invalidate your signature and require resigning.
