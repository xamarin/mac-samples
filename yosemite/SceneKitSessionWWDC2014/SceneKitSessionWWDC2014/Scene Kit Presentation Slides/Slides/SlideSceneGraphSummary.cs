	...
	public class SlideSceneGraphSummary : Slide
	{
		...
		public override void PresentStep (int index, PresentationViewController presentationViewController)
		{
			...
			case 3:
				...
				earthOrbit.Geometry.FirstMaterial.Diffuse.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/orbit", "png"));
			...
			case 4:
				...
				SunHaloNode.Geometry.FirstMaterial.Diffuse.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/sun-halo", "png"));
				...
				EarthNode.Geometry.FirstMaterial.Diffuse.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/earth-diffuse-mini", "jpg"));
				EarthNode.Geometry.FirstMaterial.Emission.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/earth-emissive-mini", "jpg"));
				EarthNode.Geometry.FirstMaterial.Specular.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/earth-specular-mini", "jpg"));
				MoonNode.Geometry.FirstMaterial.Diffuse.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/moon", "jpg"));
				SunNode.Geometry.FirstMaterial.Multiply.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/sun", "jpg"));
				SunNode.Geometry.FirstMaterial.Diffuse.Contents = new NSImage (NSBundle.MainBundle.PathForResource ("Scenes.scnassets/earth/sun", "jpg"));
