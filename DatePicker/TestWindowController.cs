...
namespace DatePicker
{
	public partial class TestWindowController : AppKit.NSWindowController
	{
		...
		{
			var tag = (NSDatePickerStyle)(long)sender.SelectedCell.Tag;
                        
			if (datePickerControl.DatePickerStyle != tag) {
				var windowFrame = this.Window.Frame;
				var boxFrame = outerBox.Frame;
		...
		{
			var tag = (NSControlSize)(long)sender.SelectedCell.Tag;
		...
		{
			switch ((DatePickerBorderStyle)(long)sender.SelectedCell.Tag) {
		...
		partial void setDateElementFlags (NSMatrix sender)
		{
			...
			switch ((DateElementSelections)(long)sender.SelectedCell.Tag) {
		...
		partial void setTimeElementFlags (NSMatrix sender)
		{
			...
			switch ((TimeElementSelections)(long)sender.SelectedCell.Tag) {
		...
		{
			switch ((DatePickerModeSelections)(long)sender.SelectedCell.Tag) {
